...
namespace EveOPreview.View
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			HideCaptionOnClientsCheckBox.Location = new Point(13, 202);
			HideCaptionOnClientsCheckBox.Margin = new Padding(6, 7, 6, 7);
			HideCaptionOnClientsCheckBox.Name = "HideCaptionOnClientsCheckBox";
			HideCaptionOnClientsCheckBox.Size = new Size(250, 29);
			...
			LabelOverlayLabelFont.Location = new Point(13, 215);
			LabelOverlayLabelFont.Margin = new Padding(6, 0, 6, 0);
			LabelOverlayLabelFont.Name = "LabelOverlayLabelFont";
			LabelOverlayLabelFont.Size = new Size(159, 25);
			LabelOverlayLabelFont.TabIndex = 45;
			LabelOverlayLabelFont.Text = "Overlay Lable Font";
			// 
			// btnLabelFont
			// 
			btnLabelFont.Location = new Point(9, 184);
			btnLabelFont.Name = "btnLabelFont";
			btnLabelFont.Size = new Size(112, 30);
			...
			OverlayLabelColorButton.Location = new Point(321, 179);
